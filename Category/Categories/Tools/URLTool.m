...
+ (BOOL)isURL:(NSString*)url
{
    ...
    if([url hasPrefix:@"project://"]||
       [url hasPrefix:@"home://"]||
       [url hasPrefix:@"document://"]||
       [url hasPrefix:@"caches://"]||
       [url hasPrefix:@"tmp://"]||
       [url hasPrefix:@"defaults://"]||
       [url hasPrefix:@"/User"]||
       [url hasPrefix:@"/var"]||
       [url hasPrefix:@"http://"]||
       [url hasPrefix:@"https://"]||
...
{
    if(![URLTool isURL:url]){
        return NO;
    }
    url=[URLTool urlAnalysis:url];
...
+ (NSString *)urlAnalysisToPath:(NSString *)url
{
    ...
    NSString *urlstr=[URLTool urlAnalysis:url];
...
+ (NSString *)getParamsFromURL:(NSString *)url andWithKey:(NSString *)key
{
    ...
    NSDictionary *params=[URLTool getParamsFromURL:url];
